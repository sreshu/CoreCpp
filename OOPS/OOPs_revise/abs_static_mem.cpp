...
//static var belongs to the class and not to particular obj of class

//if initilise inside class - make pi constexpr

//if outside the class , just put float const Sphere::pi_{3.14159};
